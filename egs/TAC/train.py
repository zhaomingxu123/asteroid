...
def main(conf):
    ...
    train_set = TACDataset(
        conf["data"]["train_json"], conf["data"]["segment"], conf["data"]["samplerate"]
    )
    val_set = TACDataset(
        conf["data"]["dev_json"], conf["data"]["segment"], conf["data"]["samplerate"]
    )
